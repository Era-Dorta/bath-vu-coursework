...
\begin{algorithm}[H]
 \caption{RANSAC}
 \KwData{A pair of images $I_0$, $I_1$, $k$ number of iterations, distance threshold $t$.}
...
\item \textbf{Fundamental matrix:} estimate an $F$ matrix such that $x_0'Fx_1 = 0$, where $x_0$ and $x_1$ are corresponding points in two images.
